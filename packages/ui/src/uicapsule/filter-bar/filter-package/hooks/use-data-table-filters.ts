    ...
    (nextFilters: FiltersState | ((prev: FiltersState) => FiltersState), context?: TContext) => {
      ...
      if (isControlled) {
        ...
        if (onFiltersChange.length <= 1) {
          ...
          const dispatchHandler = onFiltersChange as React.Dispatch<React.SetStateAction<FiltersState>>;
          dispatchHandler(resolvedNextFilters);
        } else {
          // Custom handler style - pass prev, next, and context
          const customHandler = onFiltersChange as (prev: FiltersState, next: FiltersState, context?: TContext) => void;
        ...
        setFilters((prevFilters) => {
          ...
          const batchActions: BatchFilterOperations = {
            addFilterValue<TData, TType extends OptionBasedColumnDataType>(
              ...
              transactionFilters = filterOperations.addFilterValue(transactionFilters, column, values);
            },
            ...
            removeFilterValue<TData, TType extends OptionBasedColumnDataType>(
              ...
              transactionFilters = filterOperations.removeFilterValue(transactionFilters, column, value);
            },
            ...
            setFilterValue<TData, TType extends ColumnDataType>(
              ...
              transactionFilters = filterOperations.setFilterValue(transactionFilters, column, values);
            },
            ...
            setFilterOperator<TType extends ColumnDataType>(
              ...
              transactionFilters = filterOperations.setFilterOperator(transactionFilters, columnId, operator);
            },

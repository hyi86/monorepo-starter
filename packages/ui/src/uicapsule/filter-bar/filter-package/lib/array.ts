...
export function minMax(values: readonly number[] | readonly bigint[]): [number, number] | [bigint, bigint] {
  let found = false;
  ...
  return found ? [minVal as bigint, maxVal as bigint] : [Number.POSITIVE_INFINITY, Number.NEGATIVE_INFINITY];
}

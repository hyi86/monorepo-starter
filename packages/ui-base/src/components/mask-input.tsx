...
import { useComposedRefs } from '@monorepo-starter/ui-base/lib/compose-refs';
...
function getCachedFormatter(locale: string | undefined, opts: Intl.NumberFormatOptions): Intl.NumberFormat {
...
function isCurrencyMask(opts: { mask: MaskPatternKey | MaskPattern | undefined; pattern?: string }): boolean {
...
function fromUnmaskedIndex(opts: { masked: string; pattern: string; unmaskedIndex: number }): number {

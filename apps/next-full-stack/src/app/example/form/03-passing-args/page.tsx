...
export default function ServerActionClientPassingArgsPage({
  ...
  return (
    <div>
      <h1>Server Action Passing Args (Client Components)</h1>
      <p>
        <code>code</code> Params 를 통해 서버 액션에 인자를 전달
      </p>

      <form action={formAction} className="flex flex-col gap-6 py-2 *:space-y-2">
        <div>

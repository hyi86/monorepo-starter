...
import { UploaderStoreProvider } from '~/common/store/uploader-provider';
import { ComponentInfoPanel } from '~/common/ui/command/component-info-panel';
import { Spotlight } from '~/common/ui/command/spotlight';
